set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { Y[1] }]; #IO_L22P_T3_34  Schematic=LD10_R
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { I[11] }]; #IO_L18N_T2_AD13N_35 Sch=VGA_R7_CON
