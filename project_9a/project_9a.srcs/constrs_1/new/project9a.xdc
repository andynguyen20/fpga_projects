...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { rst1 }]; #IO_L8P_T1_34 Schematic=BTN0
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { rst2 }]; #IO_L4N_T0_34 Schematic=BTN1

set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { sub }]; #IO_L23P_T3_35 Schematic=BTN3

set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L18P_T2_34 Sch=VGA_R6_CON
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L18N_T2_AD13N_35 Sch=VGA_R7_CON
...
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { overflow }]; #IO_L17P_T2_34 Schematic=LD10_B

set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { neg }]; #IO_L8N_T1_34 Schematic=LD11_R